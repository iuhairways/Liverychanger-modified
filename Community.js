...
newDiv.innerHTML = '<img src="https://i.ibb.co/ZVP8G2w/imagecool.jpg">Jet2';
...
if (e.lastLivery != e.currentLivery){
    ...
    if (e.currentLivery == 7){
geofs.api.changeModelTexture(multiplayer.visibleUsers[e.id].model._model, "https://i.ibb.co/ZVP8G2w/imagecool.jpg", 0);
    }
